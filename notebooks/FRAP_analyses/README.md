...
|----------|-------------|
| `FRAP_processing_RS.ipynb` | Main FRAP data processing pipeline |
| `FRAP_representative_images_RS.ipynb` | Generate representative images and videos |
| `FRAP_interpreatation_final_RS.ipynb` | Statistical analysis and trajectory plotting |

### Modules

| Module | Description |
|--------|-------------|
| `frap_plotting_module.py` | Consolidated plotting functions |
| `FRAP_processing_line_command.py` | Command-line FRAP processing script |
...
Run `FRAP_processing_RS.ipynb` to:
...
Run `FRAP_representative_images_RS.ipynb` to:
...
Run `FRAP_interpreatation_final_RS.ipynb` to:
